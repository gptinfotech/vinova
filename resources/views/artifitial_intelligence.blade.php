@include('layouts.master')
        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                ...
                <div class="col-lg-6 align-self-end text-center text-lg-end">
                    <img class="img-fluid" src="../assets/images/ai/hero-img.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img">
                        <img class="img-fluid" src="../assets/images/ai/about-img.jpg">
                    </div>
                </div>
        ...
        <div class="container pt-5">
            <div class="row g-5">
                ...
                <div class="col-lg-6 align-self-end text-center text-md-end wow fadeIn" data-wow-delay="0.5s">
                    <img class="img-fluid" src="../assets/images/ai/feature.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="case-item position-relative overflow-hidden rounded mb-2">
                        <img class="img-fluid" src="../assets/images/ai/project-1.jpg" alt="">
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="case-item position-relative overflow-hidden rounded mb-2">
                        <img class="img-fluid" src="../assets/images/ai/project-2.jpg" alt="">
                        <a class="case-overlay text-decoration-none" href="">
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.7s">
                    <div class="case-item position-relative overflow-hidden rounded mb-2">
                        <img class="img-fluid" src="../assets/images/ai/project-3.jpg" alt="">
                        <a class="case-overlay text-decoration-none" href="">
                    ...
                    <div class="row g-4">
                            ...
                            <div class="row g-4">
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="../assets/images/ai/team-1.jpg" alt="">
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.5s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="../assets/images/ai/team-2.jpg" alt="">
                        ...
                        <div class="col-md-6 pt-md-4">
                            <div class="row g-4">
                                <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="../assets/images/ai/team-3.jpg" alt="">
                                ...
                                <div class="col-12 wow fadeIn" data-wow-delay="0.7s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="../assets/images/ai/team-4.jpg" alt="">
                    ...
                    <div class="owl-carousel testimonial-carousel border-start border-primary">
                        <div class="testimonial-item ps-5">
                            ...
                            <div class="d-flex align-items-center">
                                <img class="img-fluid flex-shrink-0 rounded-circle" src="../assets/images/ai/testimonial-1.jpg"
                        ...
                        <div class="testimonial-item ps-5">
                            ...
                            <p class="fs-4">Aliqu diam amet diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet</p>
                            <div class="d-flex align-items-center">
                                <img class="img-fluid flex-shrink-0 rounded-circle" src="../assets/images/ai/testimonial-2.jpg"
                                    style="width: 60px; height: 60px;">
                                <div class="ps-3">
                                    <h5 class="mb-1">Client Name</h5>
                                    <span>Profession</span>
                        ...
                        <div class="testimonial-item ps-5">
                            ...
                            <p class="fs-4">Aliqu diam amet diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet</p>
                            <div class="d-flex align-items-center">
                                <img class="img-fluid flex-shrink-0 rounded-circle" src="../assets/images/ai/testimonial-3.jpg"
                                    style="width: 60px; height: 60px;">
                                <div class="ps-3">
                                    <h5 class="mb-1">Client Name</h5>
                                    <span>Profession</span>
    ...
    <script src="../assets/ailib/wow/wow.min.js"></script>
    <script src="../assets/ailib/easing/easing.min.js"></script>
    <script src="../assets/ailib/waypoints/waypoints.min.js"></script>
    <script src="../assets/ailib/counterup/counterup.min.js"></script>
    <script src="../assets/ailib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Template Javascript -->
    <script src="../assets/js/ai/main.js"></script>
